...
import placeholderImage from "../assets/images/123.jpeg"
    ...
    return(
        <a href={url}>
            <Card className="h-100"> 
                ...
                <Image className={`card-img-top ${styles.image}`} alt="image" src={validImageUrl || placeholderImage} width={500} height={200} />
                <Card.Body>
